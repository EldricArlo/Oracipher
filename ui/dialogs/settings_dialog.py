...
class SettingsDialog(QDialog):
    ...
    def _init_settings_tab(self, parent_tab: QWidget) -> None:
        ...
        change_pass_button.setFixedWidth(200); change_pass_button.clicked.connect(self.change_password_requested.emit)
    ...
    def _init_instructions_tab(self, parent_tab: QWidget) -> None:
        ...
        instructions_text.setTextInteractionFlags(Qt.TextInteractionFlag.TextBrowserInteraction)
