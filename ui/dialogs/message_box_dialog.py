...
class CustomMessageBox(QDialog):
    ...
    def init_ui(self, title: str, message: str) -> None:
        ...
        main_layout.setContentsMargins(30, 30, 30, 30); main_layout.setSpacing(15)
        
        title_label = QLabel(title); title_label.setObjectName("dialogTitle")
        ...
        if self.dialog_type == self.DialogType.Question:
            ...
            cancel_button.setObjectName("cancelButton"); cancel_button.clicked.connect(self.reject)
            button_layout.addWidget(cancel_button)
            
        ok_button = QPushButton(t.get('button_ok'))
        ok_button.setObjectName("saveButton"); ok_button.clicked.connect(self.accept)
        button_layout.addWidget(ok_button)
        
        main_layout.addWidget(title_label); main_layout.addWidget(message_label)
        main_layout.addSpacing(10); main_layout.addLayout(button_layout)
