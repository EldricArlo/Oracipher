...
class EnterSecretDialog(QDialog):
    ...
    def init_ui(self) -> None:
        ...
        title_label = QLabel(t.get('2fa_enter_secret_title')); title_label.setObjectName("dialogTitle")
        instruction_label = QLabel(t.get('2fa_enter_secret_instructions')); instruction_label.setWordWrap(True)
        
        self.secret_input = QLineEdit(); self.secret_input.setPlaceholderText(t.get('2fa_enter_secret_placeholder'))
        ...
        main_layout.addWidget(title_label); main_layout.addWidget(instruction_label)
        main_layout.addWidget(self.secret_input); main_layout.addLayout(button_layout)
