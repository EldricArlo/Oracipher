...
![Oracipher Banner](images/icon-256.png)
...
| :----------------------------------------------------------: | :-----------------------------------------------------------: |
| ![Light Theme Screenshot](./images/screenshot_light.png) | ![Dark Theme Screenshot](./images/screenshot_dark.png) |
<!-- 建议您将实际的软件截图放置在 /images 目录下并更新路径 -->
