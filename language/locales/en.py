...
translations = {
    ...
    "msg_import_confirm": "You are about to import entries.\nThis is a smart merge operation: new entries will be added, existing entries with updated information will be overwritten, and identical duplicates will be skipped. Continue?",
